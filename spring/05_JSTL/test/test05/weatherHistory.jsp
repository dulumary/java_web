                            ...
                            <tr>
                                ...
                                <c:choose>
									<c:when test="${weather.weather eq '맑음'}">
										<img src="/lesson05/test05/images/sunny.jpg">
									</c:when>
									<c:when test="${weather.weather eq '구름조금'}">
										<img src="/lesson05/test05/images/partlyCloudy.jpg">
									</c:when>
									<c:when test="${weather.weather eq '흐림'}">
										<img src="/lesson05/test05/images/cloudy.jpg">
									</c:when>
									<c:when test="${weather.weather eq '비'}">
										<img src="/lesson05/test05/images/rainy.jpg">
									</c:when>
									<c:otherwise>
										${weather.weather }
									</c:otherwise>
